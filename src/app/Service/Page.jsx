...
const Service = () => {
  return (
    <div className="h-full md:border-l md:text-justify flex flex-col justify-between text-center border-b mb-5 md:mb-0 md:border-0">
      <div className="m-10">
        ...
        <p className="text-sm font-roboto-mono my-6">
          ...
          ownership over remastered SOPs. The ability to say “This is the Way”.
          To empower project teams that know what to do (and why).
        </p>
        <p className="text-sm font-roboto-mono my-6">
          CONSTRUCTION MANAGEMENT SOFTWARE (CMS). Industry leading experts for
          CMS (re-)implementations and optimization strategy. Hands-on system
        ...
        <p className="text-sm font-roboto-mono my-6">
          ...
          insights by connecting your systems and having it flow the way you
          want it to. Then we’ll help build custom visualizations to better
